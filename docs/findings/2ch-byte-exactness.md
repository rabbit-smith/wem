...
`tests/integration/test_facade_parity.py` also holds an asset-free
...
to the Rust output, and `tests/parity/test_2ch_corpus.py` pins the
...
`tests/parity/test_2ch_corpus.py` checks the batch kernel, the Python
