...
| The shipped wheel decodes through its embedded kernel: the declared geometry and frame count of the container it encoded, in a clean environment | `make wheel-smoke` (`scripts/wheel_smoke.py`) |
