"""Frame scheduling: the plan stream and the mode selector that drives it.

The planner owns readiness, advance and the immutable state sequence; the
selector owns the transient queue, the scan and the transition code that
becomes the next plan's modes. They are two halves of one decision, so they
share a module. Each class keeps its own test names and failure messages.
"""
...
# --------------------------------------------------------------------------
# merged from tests/unit/scheduling/test_frame_scheduler.py
# --------------------------------------------------------------------------
...
# --------------------------------------------------------------------------
# merged from tests/unit/scheduling/test_scheduler_runtime.py
# --------------------------------------------------------------------------
