"""The psychoacoustic kernels: temporal weighting and the seed floor walk.

Two numeric regressions from one package, each pinning the exact arithmetic
of one kernel: the temporal kernel and its history relaxations, and the seed
floor walk with the bounds it must report instead of reading past its
surface. Each keeps its own test names and failure messages.
"""
...
from wwise_wem_reference.analysis.psychoacoustics.seed import wwise_apply_max_seed_floor
...
# --------------------------------------------------------------------------
# merged from tests/unit/analysis/test_psy_temporal_state.py
# --------------------------------------------------------------------------
...
# --------------------------------------------------------------------------
# merged from tests/unit/analysis/test_seed_floor_bounds.py
# --------------------------------------------------------------------------
