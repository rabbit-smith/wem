#!/usr/bin/env python3
"""Paired-corpus toolkit for the round (Wwise WEM encoder calibration).
...
Design notes:
  * The WAVs are 2-channel / 48000 Hz / signed-16 PCM to match the DLL's
    2ch/48k quality profile (profile idx 0/2, rate band 45000-50000).
...
<!--
  Minimal Wwise 2013.2 project template for the round WEM calibration.
