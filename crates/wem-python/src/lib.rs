...
//!
//! Exposes the module `_wwise_wem_native` — a thin, zero-drift shell over
//! the kernel:
//!
...
#[pyclass(name = "Encoder", module = "_wwise_wem_native")]
struct PyEncoder {
    inner: WemEncoder,
}
...
#[pyclass(name = "EncodeResult", module = "_wwise_wem_native")]
#[derive(Clone)]
...
#[pyclass(name = "StreamSession", module = "_wwise_wem_native")]
...
#[pyclass(name = "Packet", module = "_wwise_wem_native")]
#[derive(Clone)]
struct PyPacket {
    #[pyo3(get)]
    seq: u32,
...
#[pyclass(name = "WemComplete", module = "_wwise_wem_native")]
#[derive(Clone)]
...
#[pymodule]
fn _wwise_wem_native(m: &Bound<'_, PyModule>) -> PyResult<()> {
    let py = m.py();
...
mod tests {
    ...
    fn import_module(py: Python<'_>) -> PyResult<Bound<'_, PyModule>> {
        Ok(pyo3::wrap_pymodule!(_wwise_wem_native)(py).into_bound(py))
    }
